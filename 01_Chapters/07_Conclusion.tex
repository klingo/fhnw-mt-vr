...
1 methods of user input
2 interaciton patterns
3 visualising in 3d
4 benefits

With the suggestion of a design that utilizes the most suitable input methods for \gls{vr} and state of research interaction patterns, a valid option for enhancing the exploratory analysis of categorized financial data is proposed.




Starting from the problem statement that information overload in today’s world is becoming more and more a challenge – which could be addressed with the steadily growing potential of smartphones – this thesis proposed a solution approach. By designing a system that is using smartphone sensors to sense a person’s life and daily routines – and providing back the evaluated activity information into a task management system, a valid option for enhancement was proposed as research objective.

ebanking problems and riseu of vr
analysis of input devices
analysis of interaction patterns + vism
analysis of data visualisation
ssuggestion for a design
