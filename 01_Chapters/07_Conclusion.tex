...
\begin{itemize}[]
	\item TODO: less minimum no of steps, sometimes only 50\%
	\item TODO: multiple linked views reduce interactoin steps
	\item modularity of bar charts and tables, reusability
\end{itemize}
