...
Independent of whether the month and/or year selection was changed, the list of financial transactions will always be updated accordingly. It therefore can either display all transactions from a whole year, or from a single month only.
...
Compared to Path 1, this is an additional (data) filter that is applied on the selected data set from View 3. Individual categories can be enabled and disabled. A change in View 4 will always trigger all three interaction paths: 6, 7 and 8,

\textbf{Path 7: View 4 \textrightarrow View 2} \newline
Very similar to Path 6, this is an additional (data) filter that is applied on the selected data set from View 3. A change in View 4 will always trigger all three interaction paths: 6, 7 and 8,

\textbf{Path 8: View 4 \textrightarrow View 3} \newline

A change in View 4 will always trigger all three interaction paths: 6, 7 and 8,
