...
\begin{itemize}[noitemsep,nolistsep]
	\item High interactivity with tightly coupled actions/reactions (i.e. no slow animations, no timed events, or any other change in scenery without a trigger from the user)
\end{itemize}
