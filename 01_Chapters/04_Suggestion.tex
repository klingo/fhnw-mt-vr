...
- start with a small table on which a house etc is visualized.
- Each object represents one category from the financial expenses.
- The colours depends on the difference between my planned expenses and the actual expenses. less = green, about the same = yellow-(green-)ish, slightly above = orange, above = red.
