...
From within the Year Overview it is also possible to trigger a month change by selecting one of the 'bars' in the chart. In addition to that, it will also update the currently selected month in View 3 (not visualized in Figure \ref{fig:interactionmap}).
