...
Starting from this first view, the user can select a year and/or a month which will trigger a data update on the Year Overview (Path 1), the Month Overview (Path 2), and the list of Financial Transactions (Path 3). \newline
