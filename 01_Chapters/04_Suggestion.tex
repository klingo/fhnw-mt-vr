...
\end{itemize}
From a \gls{vr} perspective, these are all the goals that are set for the design, as the main goals are related to the data which are discussed in the following chapter.
