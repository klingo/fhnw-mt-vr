...
Manipulation of the underlying data set itself is not possible in this design. However, there is one direct manipulation possibility for 3D objects in one of the views.
