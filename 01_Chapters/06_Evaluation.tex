...
%	SUBSECTION 1
%-----------------------------------
\subsection{Scenario 1: Checking for specific executed payment}
...
\subsection{Scenario 2: Comparing monthly household expenses with previous year}
...
\subsection{Scenario 3: Figuring out why the account balance is at zero in the middle of the month}
...
\subsection{Scenario 4: Exploring the financial impact of a changed living lifestyle}
