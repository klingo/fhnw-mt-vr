...
\begin{enumerate}[noitemsep,nolistsep]
	...
	\item Comparing monthly expenses with previous year
	\item Figuring out why  account balance is zero in the middle of the month
	\item Tracking the monthly household expenses to not exceed the planned budget
\end{enumerate}
...
\textbf{Title:} Comparing monthly expenses with previous year
...
\textbf{Title:} Tracking the monthly household expenses to not exceed the planned budget
