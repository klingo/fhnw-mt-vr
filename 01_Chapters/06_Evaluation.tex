...
%	SUBSECTION 1
%-----------------------------------
\subsection{Checking for specific financial transaction}
...
\subsection{Comparing monthly household expenses with previous year}
...
\subsection{Figuring out why the account balance is at zero in the middle of the month}
...
\subsection{Exploring the financial impact of a changed living lifestyle}
