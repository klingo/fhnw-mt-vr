...
\end{framed} \label{SRQ3}
 ...
 The first three \glspl{srq} are answered as part of the literature review, whereas \gls{srq} 4 is answered with the implementation of a prototype as part of the evaluation.
