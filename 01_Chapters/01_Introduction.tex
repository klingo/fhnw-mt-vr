...
This master thesis provides on overview of the current state of research regarding the usage of gesture controllers and 360° motion tracking to enhance the interaction in \gls{vr} with data about the personal financial expenses.
