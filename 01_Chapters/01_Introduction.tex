...
\end{framed} \label{SRQ3}
 ...
 The first three \glspl{srq} are answered as part of the literature review, whereas \gls{srq} 4 is answered with the design and implementation of a prototype application.

 
 TODO: double check SRQ 4!!!
