...
Technological advancements are of constant nature to us and affect most areas in our lifes. Just twenty years ago, one had to go to a physical branch of a bank to make a simple payment or check the current account balance. Then online banking emerged, soon followed by mobile banking, and the next big advancement might just be waiting ahead of us.

This master thesis focuses on the possibilities of virtual reality to visualize categorized financial expenses with the intention to make its exploratory analysis more simple and provide better insights into trends and changes.

In the following sub-chapters, more information about the topic is given and the problem statement is defined. Based on this, the thesis statement is defined and 

TODO:
% In the next subchapters more background information about the topic is given – and the problem statement is defined. Based on that the thesis statement of this work is proposed – and research questions are derived. After the delineations and limitations are presented the thesis map at the end of the chapter shows how the rest of the paper is structured and what relations exists between the chapters.
