...
A very similar approach to this, although not in \gls{vr}, has been applied in the city building simulation PC Game "Cities: Skylines", published by \cite{Paradox2014}, where certain info views such as the fire safety has been directly visually applied to the individual houses with different colours, as shown in Figure \ref{fig:citiesskylinesfiresafety}.
