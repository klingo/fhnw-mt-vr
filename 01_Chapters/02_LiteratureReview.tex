...
In the analysis of \gls{vism} by \cite{Craft2005}, they point out that it should only be seen as guidelines and also note that although it defines some tasks that a system \textit{should} fulfill, it gives no indication on the question \textit{"How?"}.
...
When the visual information-seeking mantra fails \cite{Neil2006}, they point
