...
The third an final \gls{srq} focuses on the selection and enhancement of existing interactions patterns with new methods for user input which will be implemented, tested and evaluated in a \gls{vr} application prototype. It therefore is not discussed as part of the Master Thesis Research Proposal.
