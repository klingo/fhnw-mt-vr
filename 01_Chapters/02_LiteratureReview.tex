...
\end{itemize}
In addition, the spoken \textit{"there"} serves as some kind of voice button where the "there" refers to the cursor position in which the gestures as an input method come into play as well \citep{Bolt1980}.
