...
In contrast to the traditional chart-like presentations that can be used for almost any kind of data, the "data-type-focused" ones are specifically tailored to the individual type of information and might not be effectively re-usable for others.
