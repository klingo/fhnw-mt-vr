...
\cite{Hentschel2009} was looking into creating a three-dimensional scatter plot in \gls{vr} as also shown in Figure \ref{fig:interactivebrushing} in chapter \ref{HentschelFigureRef}.
