...
In order to further analyse the different data presentations, we can distinguish between the traditional visualization methods summarised as 'Charts' and the specifically for \gls{vr} designed, data-type-focused methods.
