...
\begin{itemize}[noitemsep,nolistsep]
	\item \gls{vr} exhibits high interactivity - there is a tight coupling between the user's actions and the feedback generated by those actions
	\item \gls{vr} support embodiment - some sort of representation of the user is in the same spatial framework as the data
	\item The \gls{vr} representation is spatial in nature; virtual objects are situated in a spatial framework
\end{itemize}
