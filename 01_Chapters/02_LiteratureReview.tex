...
When we talk about the presentation of data, many will immediately think of Microsoft Excel and the many different charts that can be created with just a few clicks based on almost any data set. We know them as bar chart, line chart, pie chart, scatter plots and many more, but also big \gls{bi} solutions like \citep{TableauSoftware2016} rely on these well known and widely accepted techniques for the visualization of data.
