...
\begin{table}[h]
	\begin{center}
		\begin{tabular}{ | p{3.5cm} | p{5cm} | p{5cm} | } 
			\hline
			\textbf{Pattern} & \textbf{Strengths} & \textbf{Weaknesses} \\
			\hline
			Travel &
			- aaa \newline - aaaa &
			- bbb \newline - bbb \\
			\hline
			Selection: \newline \textit{Hand} & 
			- Highest familiarity \newline - Different techniques possible  & 
			- Requires accurate tracking \newline - Limited control with hand gestures \\
			\hline
			Selection: \newline \textit{HMD Reticle} &
			- Simple technique \newline - No additional hardware required &
			- Tied to viewing experience \newline - Limited multitasking \newline - Limited interaction \\
			\hline
			Selection: \newline \textit{Gesture Controller} &
			- Similar to hand selection \newline - ggg &
			...
			\hline
		\end{tabular}
		\caption{Strengths and weaknesses of different interaction patterns in virtual reality}
		\label{tbl:patterncomparison}
	\end{center}
\end{table}
