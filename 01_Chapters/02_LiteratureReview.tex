...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Navigation and Overview mode in a Data Forest with a complext data set]{Navigation (1) and Overview (2) mode in a Data Forest with a complext data set \citep{Jamieson2007}}
		\label{fig:datatrees}
	\end{center}
\end{figure} 
