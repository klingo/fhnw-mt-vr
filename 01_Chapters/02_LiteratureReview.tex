...
\cite{Kwon2015} specify this more by saying that in a 2D environment/space (like a regular screen) it makes sense to also use 2D objects for the presentation, whereas in a \gls{vr} environment where the viewing direction can be freely chosen by the user, the whole three dimensional space should be utilized. 
...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Rotating data rings with varying speed in \gls{vr}]{Rotating data rings with varying speed in \gls{vr} \citep{CodeScience2015}}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption[Outside view on tower built from rotating data rings with varying speed in \gls{vr}]{Outside view on tower built from rotating data rings with varying speed in \gls{vr} \citep{CodeScience2015}}
