...
\end{itemize}
By referring back to the list of characteristics from \cite{Stone1994}, the eight parameters focus on \textit{Position, Size and Colour} while the idea of the data forest itself focuses on \textit{Shape}. The visualized data forest can be seen in Figure \ref{fig:dataforest}.
