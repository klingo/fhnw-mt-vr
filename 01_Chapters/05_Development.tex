...
Since the different views are rather far away from where the user is spawned, a pointer functionality has been introduced to the gesture controllers. . These tooltips should help to familiarize the user with the functions that are available to him from the gesture controllers.


This is shown in Figure \ref{fig:unitypointertooltips} alongside the button tutorial of the controller which is shown for a limited time in the form of tooltips
