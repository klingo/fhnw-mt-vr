...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Unity 3D CPU Usage with single-threaded execution of updateSelection() workfow}
...
\begin{figure}[h]
	\begin{center}
		...
		\caption{Unity 3D CPU Usage with multi-threaded execution of updateSelection() workfow}
