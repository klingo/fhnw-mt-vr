...
\begin{itemize}[noitemsep,nolistsep]
	\item From View 1 and 2: Selecting a bar in a bar chart (Path 3 and 4)
	\item From View 3: Selecting a different year (Path 1 and 2)
	\item From View 4: Selecting a category icon (Path 5, 6, and 7)
	\item From View 5: Selecting a row in the table (Path 8)
\end{itemize}



Year Selection (Path 1 and 2)
Clicking on bar in chart (Path 3 and 4)
Clicking on category icon (Path 5, 6, and 7)
Clicking on row in table (Path 8)
