...
\begin{itemize}[noitemsep,nolistsep]
	\item There is no real difference between \texttt{String} and \texttt{string}
	...
	\item Additional core-features from .NET have to be manually added by activating the corresponding \texttt{*.dll}
