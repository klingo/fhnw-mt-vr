...
This combination of input methods are best met with the HTC Vive (\url{https://www.vive.com/}) that was unveiled by HTC in early 2016. The bundle consists of a \gls{hmd}, two gesture controllers (see Figure \ref{fig:gesturecontroller} in Chapter \ref{SubSubSectionGestureControllers}) and two so called 'Lighthouses' (see Figure \ref{fig:lighthouses} in Chapter \ref{360MotionTracking}) that when set up in opposite corner allow for a full motion tracking.
