...
\begin{figure}[h]
	\begin{center}
		...
		\caption{View 1: Year Overview in (live in \gls{vr})}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=14cm]{03_Figures/08_Development/View4_CategoriesFiltering.png}
		\caption{Scene Overview in Unity 3D}
