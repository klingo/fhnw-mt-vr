...
\end{itemize}
With eleven categories, over 2'048 different combinations can be made. If this is considered for a whole year there are a staggering amount of 747'520 different key-combinations, which makes it impractical to pre-cache every single combination. 
