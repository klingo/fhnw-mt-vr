...
It is important to have an effective and clean code structure that reflects the different layers which all together become the software itself. The following Figure \ref{fig:unitycodestructure} shows the project structure in Unity 3D while Table XXX explains this in more detail.
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=7cm]{03_Figures/08_Development/CodeStructure.png}
		\caption[Prototype project structure]
		\label{fig:unitycodestructure}
	\end{center}
\end{figure}


A good and clean code structure which reflects the logical layers makes the implementation better readable, easier to understand and reduces the efforts needed for maintenance and further adaption of the code (Martin, 2009)
The following section shortly explains the major logical folders and its logic. Figure 32 shows the project structure and Table 24 explains the details about the structure.
