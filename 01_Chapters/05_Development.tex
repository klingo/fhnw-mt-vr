...
\begin{longtable}{ | p{3cm} | p{11cm} |}
	...
	\hline
		Prefabs &
		In this folder, fully configured GameObjects can be stored and instantiated multiple times. All instances inherit the base configuration and changes can be applied to all of them very easily. The individual bars of the bar chart are such a prefab. \\
	\hline
		Resources &
		tbd \\
	\hline
