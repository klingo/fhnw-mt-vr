...
In this chapter, an overview of all the views and their usage is provided, as well the interactions between them is discussed.
...
\textbf{Possible Interaction:}
\begin{itemize}[noitemsep,nolistsep]
	\item Selecting a bar to see the month overview bar chart (Path 3)
	\item Selecting a bar to see a list of all financial transactions for that month (Path 4)
\end{itemize}
...
\textbf{Possible Interaction:}
\begin{itemize}[noitemsep,nolistsep]
	\item Selecting a bar to see a list of all financial transactions for that single day (Path 4)
\end{itemize}
...
\textbf{Possible Interaction:}
\begin{itemize}[noitemsep,nolistsep]
	\item Selecting a year to see the year overview bar chart (Path 1)
	\item Selecting a year to clear the month overview bar chart (Path 2)
	\item Selecting a year to clear the table with financial transactions (Path 4)
\end{itemize}
...
\textbf{Possible Interaction:}
\begin{itemize}[noitemsep,nolistsep]
	\item Selecting a category icon to apply the filter on the year overview bar chart (Path 5)
	\item Selecting a category icon to apply the filter on the month overview bar chart (Path 6)
	\item Selecting a category icon to apply the filter on list of financial transactions (Path 7)
\end{itemize}
...
\textbf{Possible Interaction:}
\begin{itemize}[noitemsep,nolistsep]
	\item Selecting a row to see full transaction details (Path 8)
\end{itemize}
