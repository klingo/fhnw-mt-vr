...
The general architecture of the prototype will be based on general knowledge from Software Engineering and the utilization of the SDK and framework provided by Unity 3D.
