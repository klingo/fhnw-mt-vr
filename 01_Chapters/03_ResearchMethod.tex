...
The general architecture of the prototype is based on general knowledge from software engineering and the utilization of the \gls{sdk} and framework provided by Unity 3D.
