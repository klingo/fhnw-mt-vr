...
\cite{Hevner2010} defined that in this phase, a preliminary suggestion for a solution is created that is based on the knowledge gathered from the Literature Review in chapter \ref{ChapterLiteratureReview}.

The next stage is a preliminary suggestion for a problem solution that is abductively drawn from the existing knowledge or theory based on the problem area or developed using an appropriate research methodology. \cite{Hevner2010}


Hevner and Chatterjee (2010) prescribe that the suggestion phase contains the goals of a solution, which are derived from the previous phase. For this thesis the suggestion will be derived by sub research questions three and four:
...
\begin{table}[h]
	...
	\end{center}
\end{table} \newline
For this research, the methods from \textit{Testing} and \textit{Descriptive} will be applied (also highlighted in Table \ref{tbl:designevaluationmethods}). \newline
...
Table \ref{tbl:researchMethodSummary} summarizes the outcome of this chapter:
\begin{table}[h]
	\begin{center}
		\begin{tabular}{ | m{2.5cm} | p{2.5cm} | p{8cm} | }
			\hline
				\multirow{5}{*}{\textbf{Design}}
				& Philosophy
				& Interpretivism \\
				\cline{2-3}
				& Approach
				...
				& Qualitative \\
			\hline
				\multirow{10}{*}{\textbf{Methodology}}
				& Awareness
				& Primarily during Literature Review. \\
				\cline{2-3}
				& Suggestion
				& Design of the artefact based on the findings from the Literature Review and further research. \\
				\cline{2-3}
				& Development
				& Development of a software artefact (virtual reality prototype). The artefact is the main focus of the research. \\
				\cline{2-3}
				& Evaluation
				& Testing methods (Functional and Structural) and Descriptive methods (Informed Argument and Scenarios) \\
				\cline{2-3}
				& Conclusion
				& Review of research and presentation of the results. \\
			\hline
		\end{tabular}
		\caption[Summary of the outcomes for the Research Method]{Summary of the outcomes for the Research Method}
		\label{tbl:researchMethodSummary}
	\end{center}
\end{table}
