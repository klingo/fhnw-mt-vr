...
The design research is an appropriate research strategy for this thesis as an artefact is developed, which has a high relevancy for practitioners. The problem is identified and a partial suggestion is provided in the literature review of this thesis. In the following chapters the suggestion is completed with a mapping of the MDS-HC questions to possible sensors. Then a pre-prototype is developed, evaluated by an experiment and analysed using four different algorithms.


Table \ref{tbl:researchMethodSummary} summarizes the outcomes of this chapter:
\begin{table}[h!]
	\begin{center}
