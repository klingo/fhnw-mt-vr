...
\cite{Hevner2010} defined the initial step of the \gls{dsr} cycl,e the \textit{Awareness of Problem} phase, where
\begin{itemize}[noitemsep,nolistsep]
