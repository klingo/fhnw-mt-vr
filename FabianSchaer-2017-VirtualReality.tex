...
The research in this master thesis discovered that autonomous navigation requires three
fundamental components in order to work. First, the robot must be location-aware.
The robot must then be able to sense its surroundings to gain knowledge about the
environment. Finally, the robot needs articial intelligence to recognize and interpret
the information, using such data to derive control commands. With the exception of
the articial intelligence component, Google Project Tango includes all the necessary
features such as motion tracking, area learning and depth perception. The validation of
the provided features is an integral part of this master thesis. The quality, accuracy and
reliability of the Google Project Tango system was therefore assessed and discussed. It
was proven,, that the accuracy of the motion tracking component is only high and stable
if the tests are conducted under laboratory conditions. For ad-hoc applications, the
results 
uctuate between sucient and poor. However, the depth perception capability
was found to be quite accurate within the ocial operation range, although the quality
was not sucient in terms of the resolution of the measurement. Overall, the current
release of Google Project Tango is still relatively unstable and not very reliable for
