...
\thesisTitle{Using Gesture Controllers and 360° Motion Tracking to Enhance Data Interaction in Virtual Reality}
...
%\fillingPage{} 
%\include{02_Appendices/AppendixB}
...
%----------------------------------------------------------------------------------------
%	ADDITIONAL STUFF, SPECIFIC FOR PROGRAMMING CODE (C-Sharp)
%----------------------------------------------------------------------------------------
